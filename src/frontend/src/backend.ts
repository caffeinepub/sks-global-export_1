...
export class Backend implements backendInterface {
    ...
    async addCustomer(arg0: CustomerId, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addProduct(arg0: ProductId, arg1: string, arg2: string, arg3: bigint, arg4: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addToInventory(arg0: ProductId, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addToInventory(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async confirmPickup(arg0: PickupId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.confirmPickup(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createBill(arg0: BillId, arg1: CustomerId, arg2: Array<ProductId>, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createBill(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createInvoice(arg0: InvoiceId, arg1: Array<BillId>, arg2: bigint, arg3: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createPickup(arg0: PickupId, arg1: VendorId, arg2: Array<ProductId>, arg3: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createPickup(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async processReturn(arg0: BillId, arg1: Array<ProductId>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.processReturn(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        currentCompanyId: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.currentCompanyId))
    };
}
...
function to_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        currentCompanyId: value.currentCompanyId ? candid_some(value.currentCompanyId) : candid_none()
    };
}
